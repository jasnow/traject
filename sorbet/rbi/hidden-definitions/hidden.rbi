...
class CSV
  ...
  def self.generate_line(row, options=T.unsafe(nil)); end
...
module Hashie::Extensions::IndifferentAccess
  include ::Traject::Hashie::IndifferentAccessFix
end
...
module MARC
  DIRECTORY_ENTRY_LENGTH = ::T.let(nil, ::T.untyped)
  END_OF_FIELD = ::T.let(nil, ::T.untyped)
  END_OF_RECORD = ::T.let(nil, ::T.untyped)
  LEADER_LENGTH = ::T.let(nil, ::T.untyped)
  MARCHASH_MAJOR_VERSION = ::T.let(nil, ::T.untyped)
  MARCHASH_MINOR_VERSION = ::T.let(nil, ::T.untyped)
  MARC_NS = ::T.let(nil, ::T.untyped)
  MARC_XSD = ::T.let(nil, ::T.untyped)
  SUBFIELD_INDICATOR = ::T.let(nil, ::T.untyped)
  VERSION = ::T.let(nil, ::T.untyped)
end

class MARC::FastXMLWriter
  OPEN_COLLECTION = ::T.let(nil, ::T.untyped)
  OPEN_COLLECTION_NAMESPACE = ::T.let(nil, ::T.untyped)
  XML_HEADER = ::T.let(nil, ::T.untyped)
end

class MARC::XMLReader
  USE_BEST_AVAILABLE = ::T.let(nil, ::T.untyped)
  USE_JREXML = ::T.let(nil, ::T.untyped)
  USE_JSTAX = ::T.let(nil, ::T.untyped)
  USE_LIBXML = ::T.let(nil, ::T.untyped)
  USE_NOKOGIRI = ::T.let(nil, ::T.untyped)
  USE_REXML = ::T.let(nil, ::T.untyped)
end
...
class Traject::Indexer::Settings::DefaultsHash
  include ::Traject::Hashie::IndifferentAccessFix
  def []=(key, value); end
...
module Yell
  BasicFormat = ::T.let(nil, ::T.untyped)
  DefaultFormat = ::T.let(nil, ::T.untyped)
  ExtendedFormat = ::T.let(nil, ::T.untyped)
  NoFormat = ::T.let(nil, ::T.untyped)
  Severities = ::T.let(nil, ::T.untyped)
end

class Yell::Adapters::Datefile
  DefaultDatePattern = ::T.let(nil, ::T.untyped)
  Header = ::T.let(nil, ::T.untyped)
  HeaderRegexp = ::T.let(nil, ::T.untyped)
end

class Yell::Adapters::Io
  TTYColors = ::T.let(nil, ::T.untyped)
end

class Yell::Event
  CallerIndex = ::T.let(nil, ::T.untyped)
  CallerRegexp = ::T.let(nil, ::T.untyped)
end

class Yell::Formatter
  LegacyTable = ::T.let(nil, ::T.untyped)
  PatternMatcher = ::T.let(nil, ::T.untyped)
  Table = ::T.let(nil, ::T.untyped)
end

class Yell::Level
  InterpretRegexp = ::T.let(nil, ::T.untyped)
end

class Yell::Silencer
  Presets = ::T.let(nil, ::T.untyped)
end
